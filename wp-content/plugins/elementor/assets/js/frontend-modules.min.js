  ...
  [941],
  {
    ...
    169: (e, t, r) => {
      ...
      var n = r(4762),
        ...
        b = (e.exports = function (e, t, r) {
          ...
          var n = d(e);
          return (
            o(n, "source") || (n.source = v(y, "string" == typeof t ? t : "")),
            e
          );
        });
    ...
    555: (e, t, r) => {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        r(7458),
        r(9655);
      var i = (function _interopRequireWildcard(e, t) {
        ...
        s = n(r(6349));
      const o = ".e-admin-top-bar",
        a = ".e-admin-top-bar__bar-button",
        c = ".e-admin-top-bar__bar-button-title";
      class TopBarTracking extends s.default {
        static init() {
          this.waitForTopBar();
        }
        static waitForTopBar() {
          const e = document.querySelector(o);
          if (e) return void this.attachTopBarTracking(e);
          const t = this.addObserver(
              document.body,
              { childList: !0, subtree: !0 },
              () => {
                const e = document.querySelector(o);
                e &&
                  (this.attachTopBarTracking(e),
                  t.disconnect(),
                  clearTimeout(r));
              }
            ),
        ...
        static attachTopBarTracking(e) {
          e.querySelectorAll(a).forEach((e) => {
            this.addEventListenerTracked(e, "click", (e) => {
              this.handleTopBarClick(e);
            });
          }),
            this.observeTopBarChanges(e);
        }
        static observeTopBarChanges(e) {
          this.addObserver(e, { childList: !0, subtree: !0 }, (e) => {
            e.forEach((e) => {
              "childList" === e.type &&
                e.addedNodes.forEach((e) => {
                  if (1 === e.nodeType)
                    if (e.matches && e.matches(a))
                      ...
                      (e.querySelectorAll ? e.querySelectorAll(a) : []).forEach(
                        (e) => {
                          this.addEventListenerTracked(e, "click", (e) => {
                            this.handleTopBarClick(e);
                          });
        ...
        static handleTopBarClick(e) {
          const t = e.currentTarget,
            r = this.extractItemId(t);
          i.default.trackNavClicked(r, null, i.NAV_AREAS.TOP_BAR);
        }
        static extractItemId(e) {
          ...
          if (n) {
            const e = new URLSearchParams(n.split("?")[1] || "").get("page");
            if (e) return e;
            if (n.includes("/wp-admin/")) {
              const e = n.split("/wp-admin/")[1];
              if (e) return e.split("?")[0];
            }
            try {
              const e = new URL(n, window.location.origin);
              return e.pathname.split("/").filter(Boolean).pop() || e.hostname;
            } catch (e) {
              return n;
            }
          }
          const i = e.getAttribute("data-info");
          if (i) return i;
          const s = e.className
            .split(" ")
            .filter((e) => e && "e-admin-top-bar__bar-button" !== e);
          return s.length > 0 ? s.join("-") : "unknown-top-bar-button";
        }
      }
      t.default = TopBarTracking;
    },
    641: (e, t, r) => {
      "use strict";
    ...
    1265: (e, t, r) => {
      ...
      t.default = window.elementorModules = {
        ...
        importExport: {
          ...
          customizationDialogsRegistry: d.customizationDialogsRegistry,
        },
        appsEventTracking: { AppsEventTracking: p.AppsEventTracking },
        wpDashboardTracking: { WpDashboardTracking: h.default },
      };
    },
    1278: (e, t, r) => {
      "use strict";
      ...
      t.default = {
        ...
        names: {
          ...
          topBar: {
            ...
            keyboardShortcuts:
              "top_bar_elementor_logo_dropdown_keyboard_shortcuts",
            exitToWordpress:
              "top_bar_elementor_logo_dropdown_exit_to_wordpress",
    ...
    1506: (e, t, r) => {
      ...
      e.exports = function (e, t, r) {
        var f,
          ...
          callFn = function (e) {
            return E
              ? (s(e), C ? O(e[0], e[1], stop) : O(e[0], e[1]))
              : C
              ? O(e, stop)
              : O(e);
          };
        if (k) f = e.iterator;
          ...
          if (a(m)) {
            for (v = 0, _ = c(e); _ > v; v++)
              if ((y = callFn(e[v])) && l(g, y)) return y;
            return new Result(!1);
          }
          f = u(e, m);
        }
        for (b = k ? e.next : f.next; !(w = i(b, f)).done; ) {
          try {
            y = callFn(w.value);
          } catch (e) {
            p(f, "throw", e);
    ...
    1975: (e, t, r) => {
      ...
      n(
        { target: "Iterator", proto: !0, real: !0, forced: m },
        {
          filter: function filter(e) {
            ...
            return f ? i(f, this, e) : new v(a(this), { predicate: e });
          },
        }
      );
    },
      ...
      t.DashboardUtils = {
        isElementorPage() {
          const e = new URLSearchParams(window.location.search),
            t = e.get("page");
          if (t && (t.startsWith("elementor") || t.includes("elementor")))
            return !0;
          const r = e.get("post_type");
          if ("elementor_library" === r || "e-floating-buttons" === r)
            return !0;
          return document.body.className
            .split(" ")
            .some(
              (e) =>
                e.includes("elementor") &&
                (e.includes("page") || e.includes("post-type"))
            );
        },
      };
    },
    ...
    3617: (e, t, r) => {
      ...
      p(g, y) || defineIteratorPrototypeAccessor(y, _),
        (!S && p(g, v) && g[v] !== Object) ||
          defineIteratorPrototypeAccessor(v, E),
        (E.prototype = g),
        n({ global: !0, constructor: !0, forced: S }, { Iterator: E });
    },
    3658: (e, t, r) => {
      "use strict";
      var n = r(6742),
    ...
    3827: (e, t, r) => {
      ...
      var n = r(6784);
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = t.SCREEN_TYPES = t.NAV_AREAS = t.CONTROL_TYPES = void 0),
        r(5724),
        r(4846),
        r(9655);
      var i = n(r(6336)),
        ...
        u = n(r(555));
      const d = 18e5,
        p = "elementor_wpdash_session",
        h = "elementor_wpdash_pending_nav",
        g =
          ((t.CONTROL_TYPES = {
            BUTTON: "button",
            CHECKBOX: "checkbox",
      ...
      class WpDashboardTracking {
        ...
        static restoreOrCreateSession() {
          const e = this.getStoredSession();
          e
            ? ((this.sessionStartTime = e.sessionStartTime),
              (this.navItemsVisited = new Set(e.navItemsVisited)),
        ...
        static isEditorOneActive() {
          return (
            elementorCommon?.config?.editor_events?.isEditorOneActive ?? !1
          );
        }
        static processPendingNavClick() {
          try {
            ...
            if (e) {
              const { itemId: t, rootItem: r, area: n } = JSON.parse(e);
              this.navItemsVisited.add(t);
              const i = { wpdash_nav_item_id: t, wpdash_nav_area: n };
              r && (i.wpdash_nav_item_root = r),
                this.dispatchEvent("wpdash_nav_clicked", i, {
                  send_immediately: !0,
                }),
        ...
        static saveSessionToStorage() {
          ...
          sessionStorage.setItem(p, JSON.stringify(e));
        }
        ...
        static isEventsManagerAvailable() {
          return (
            elementorCommon?.eventsManager &&
            "function" == typeof elementorCommon.eventsManager.dispatchEvent
          );
        }
        static canSendEvents() {
          return elementorCommon?.config?.editor_events?.can_send_events || !1;
        }
        static dispatchEvent(e, t = {}, r = {}) {
          this.isEventsManagerAvailable() &&
            this.canSendEvents() &&
            elementorCommon.eventsManager.dispatchEvent(e, t, r);
        }
        ...
        static startSessionMonitoring() {
          (this.activityCheckInterval = setInterval(() => {
            ...
            window.addEventListener("beforeunload", () => {
              this.sessionEnded ||
                this.isNavigatingToElementor ||
                this.trackSessionEnd("tab_closed");
            }),
            document.addEventListener("visibilitychange", () => {
              if (!this.sessionEnded && document.hidden) {
                Date.now() - this.lastActivityTime > d &&
                  this.trackSessionEnd("tab_inactive");
              }
            });
        }
        static isElementorPage(e) {
          try {
            const t = new URL(e, window.location.origin).searchParams,
              r = t.get("page"),
              n = t.get("post_type"),
              i = t.get("action"),
              s = ["elementor_library", "e-floating-buttons"];
            return (
              (r &&
                [
                  "elementor",
              ...
              (n && s.includes(n)) ||
              (i && i.includes("elementor"))
            );
          } catch (e) {
            return !1;
          }
        }
        static isPluginsPage(e) {
          try {
            return new URL(e, window.location.origin).pathname.includes(
              "plugins.php"
            );
          } catch (e) {
            return !1;
        ...
        static isNavigatingAwayFromElementor(e) {
          return !!e && !e.startsWith("#") && !this.isElementorPage(e);
        }
        static isLinkOpeningInNewTab(e) {
        ...
        static attachNavigationListener() {
          const handleLinkClick = (e) => {
              ...
              if (t && t.href) {
                if (this.isLinkOpeningInNewTab(t)) return;
                !this.sessionEnded && this.isNavigatingAwayFromElementor(t.href)
                  ? this.trackSessionEnd("navigate_away")
                  : this.isElementorPage(t.href) &&
                    (this.isNavigatingToElementor = !0);
              }
              e.target.closest("#editor-one-sidebar-navigation") &&
                (this.isNavigatingToElementor = !0);
            },
            handleFormSubmit = (e) => {
              const t = e.target;
              t.action &&
                (!this.sessionEnded &&
                this.isNavigatingAwayFromElementor(t.action)
                  ? this.trackSessionEnd("navigate_away")
                  : this.isElementorPage(t.action) &&
                    (this.isNavigatingToElementor = !0));
            };
          document.addEventListener("click", handleLinkClick, !0),
        ...
        static trackNavClicked(e, t = null, r = g.LEFT_MENU) {
          if (!this.initialized) {
            const n = { itemId: e, rootItem: t, area: r };
            return void sessionStorage.setItem(h, JSON.stringify(n));
          }
          this.updateActivity(),
            this.navItemsVisited.add(e),
            this.saveSessionToStorage();
          const n = { wpdash_nav_item_id: e, wpdash_nav_area: r };
          t && (n.wpdash_nav_item_root = t),
            this.dispatchEvent("wpdash_nav_clicked", n);
        }
        static trackScreenViewed(e, t = f.TAB) {
          this.updateActivity();
          const r = { wpdash_screen_id: e, wpdash_screen_type: t };
          this.dispatchEvent("wpdash_screen_viewed", r);
        }
        static trackActionControl(e, t) {
          this.updateActivity();
          const r = {
            wpdash_action_control_interacted: e,
            wpdash_control_type: t,
          };
          this.dispatchEvent("wpdash_action_control", r);
        }
        static trackPromoClicked(e, t, r) {
          this.updateActivity();
          const n = {
            wpdash_promo_name: e,
            wpdash_promo_destination: t,
            wpdash_promo_clicked_path: r,
          };
          this.dispatchEvent("wpdash_promo_clicked", n);
        }
        static trackSessionEnd(e = "timeout") {
          ...
          const t = Date.now() - this.sessionStartTime,
            r = {
              ...
              wpdash_endstate_duration: this.formatDuration(t),
              reason: e,
            };
          this.dispatchEvent("wpdash_session_end_state", r),
            this.clearStoredSession();
        }
        static destroy() {
          this.activityCheckInterval &&
            clearInterval(this.activityCheckInterval),
            this.navigationListeners.forEach(({ type: e, handler: t }) => {
            ...
            c.default.destroy(),
            l.default.destroy(),
            WpDashboardTracking.isEditorOneActive() || u.default.destroy(),
            (this.initialized = !1);
        }
      }
      (t.default = WpDashboardTracking),
        window.addEventListener("elementor/admin/init", () => {
          const e = window.location.href,
            t = WpDashboardTracking.isPluginsPage(e),
            r = WpDashboardTracking.isElementorPage(e);
          t && s.default.init(),
            i.default.init(),
            r &&
              ...
              c.default.init(),
              l.default.init(),
              WpDashboardTracking.isEditorOneActive() || u.default.init());
        }),
        window.addEventListener("beforeunload", () => {
          i.default.destroy(),
            s.default.destroy(),
      ...
      n(
        { target: "Iterator", proto: !0, real: !0, forced: m },
        {
          map: function map(e) {
            ...
            return f ? i(f, this, e) : new v(a(this), { mapper: e });
          },
        }
      );
    },
    4077: (e, t, r) => {
      ...
      var i = n(r(3827)),
        s = n(r(6349));
      const o =
          ".e-feature-promotion, .elementor-settings-form-page, #elementor-element-manager-wrap",
        a = ".elementor-blank_state",
        c = ".go-pro",
        l = "h3";
      class PromotionTracking extends s.default {
        static init() {
        ...
        static attachDelegatedTracking() {
          this.addEventListenerTracked(
            ...
            (e) => {
              const t = e.target;
              if (!t) return;
              const r = t.closest(`a${c}`);
              if (!r) return;
              const n = r.closest(`${o}, ${a}`);
              n && this.handlePromoClick(r, n);
            },
            { capture: !0 }
          );
        }
        static handlePromoClick(e, t) {
          const r = this.extractPromoTitle(t, e),
            n = e.getAttribute("href"),
            s = this.extractPromoPath();
          i.default.trackPromoClicked(r, n, s);
        }
        static extractPromoTitle(e, t) {
          const r = e.querySelector(l);
          return r ? r.textContent.trim() : t.textContent.trim();
        }
        static extractPromoPath() {
          const e = new URLSearchParams(window.location.search).get("page");
          return e
            ? e.replace("elementor_", "").replace(/_/g, "/")
            : "elementor";
        }
      }
      t.default = PromotionTracking;
    },
    4338: (e, t, r) => {
      "use strict";
      var n = {};
    ...
    4543: (e, t, r) => {
      ...
      class ActionControlTracking extends o.default {
        static init() {
          s.DashboardUtils.isElementorPage() &&
        ...
        static initializeLinkDataIds() {
          const initializeLinks = () => {
            document.querySelectorAll("a[href]").forEach((e) => {
              if (
                this.isExcludedElement(e) ||
                this.isNavigationLink(e) ||
                e.hasAttribute("data-id")
              )
                return;
              const t = e.getAttribute("href");
              if (!t) return;
              const r = this.removeNonceFromUrl(t);
              r && e.setAttribute("data-id", r);
            });
          };
        ...
        static addTrackingAttributesToFilterButtons() {
          ...
          let t = "";
          switch (!0) {
            case e.classList.contains("post-type-elementor_library"):
              t = "elementor_library-library";
              break;
            case e.classList.contains("post-type-e-floating-buttons"):
              t = "e-floating-buttons";
              break;
            default:
              return;
          }
          const addDataIdToListTableButtons = () => {
            [
              ...
              r &&
                !r.hasAttribute("data-id") &&
                r.setAttribute("data-id", `${t}-button-${e.suffix}`);
            });
          };
          "loading" === document.readyState
            ? document.addEventListener(
        ...
        static isExcludedElement(e) {
          for (const t of Object.values(a)) if (e.closest(t)) return !0;
          return !!e.classList.contains("go-pro");
        }
        static attachDelegatedHandlers() {
          const e = ["search-submit", "post-query-submit"];
          this.addEventListenerTracked(
            document,
            "click",
            (t) => {
              ...
              if (!r) return;
              const n = r.closest(".elementor-role-toggle");
              if (n && !this.isExcludedElement(n))
                return void this.trackControl(n, i.CONTROL_TYPES.TOGGLE);
              const s = r.closest(
                'button, input[type="submit"], input[type="button"], .button, .e-btn'
              );
              if (s && !this.isExcludedElement(s))
                return e.includes(s.id)
                  ? void this.trackControl(s, i.CONTROL_TYPES.FILTER)
                  : void this.trackControl(s, i.CONTROL_TYPES.BUTTON);
              const o = r.closest("a");
              !o ||
                this.isExcludedElement(o) ||
                this.isNavigationLink(o) ||
                this.trackControl(o, i.CONTROL_TYPES.LINK);
            },
            { capture: !1 }
          ),
            this.addEventListenerTracked(document, "change", (e) => {
              const t =
                e.target && 1 === e.target.nodeType
                  ? e.target
                  : e.target?.parentElement;
              if (!t) return;
              let r = null;
              if (
                ((r = i.default.isEditorOneActive()
                  ? t.closest(".MuiSwitch-switchBase")
                  : t.closest(".components-toggle-control")),
                r && !this.isExcludedElement(r))
              )
                return void this.trackControl(r, i.CONTROL_TYPES.TOGGLE);
              const n = t.closest('input[type="checkbox"]');
              if (n && !this.isExcludedElement(n))
                return void this.trackControl(n, i.CONTROL_TYPES.CHECKBOX);
              const s = t.closest('input[type="radio"]');
              if (s && !this.isExcludedElement(s))
                return void this.trackControl(s, i.CONTROL_TYPES.RADIO);
              const o = t.closest("select");
              o &&
                !this.isExcludedElement(o) &&
                this.trackControl(o, i.CONTROL_TYPES.SELECT);
            });
        }
        static isNavigationLink(e) {
          const t = e.getAttribute("href");
          if (!t) return !1;
          if (t.startsWith("#") && t.includes("tab")) return !0;
          if (e.classList.contains("nav-tab")) return !0;
          return !!e.closest(
            ".wp-submenu, #adminmenu, .e-admin-top-bar, #wpadminbar"
          );
        }
        static trackControl(e, t) {
          const r = this.extractControlIdentifier(e, t);
          r && i.default.trackActionControl(r, t);
        }
        static extractControlIdentifier(e, t) {
          if (i.CONTROL_TYPES.RADIO === t) {
            const t = e.getAttribute("name"),
              r = e.value || e.getAttribute("value");
            if (t && r) return `${t}-${r}`;
            if (t) return t;
          }
          if (i.CONTROL_TYPES.SELECT === t) {
            const t = e.getAttribute("name");
            if (t) return t;
          }
          if (i.CONTROL_TYPES.CHECKBOX === t) {
            const t = e.getAttribute("name");
            if (t) {
              if (
                document.querySelectorAll(
                  `input[type="checkbox"][name="${CSS.escape(t)}"]`
                ).length > 1
              ) {
                const r = e.value || e.getAttribute("value");
                if (r) return `${t}-${r}`;
              }
              return t;
            }
          }
          if (i.CONTROL_TYPES.LINK === t) {
            const t = e.getAttribute("data-id");
            if (t) return t;
            const r = e.getAttribute("href");
            if (r) return this.removeNonceFromUrl(r);
          }
          if (
            i.CONTROL_TYPES.BUTTON === t ||
            i.CONTROL_TYPES.TOGGLE === t ||
            i.CONTROL_TYPES.FILTER === t
          ) {
            const t = e.getAttribute("data-id");
            if (t) return t;
            const r = this.extractClassId(e);
            if (r) return r;
          }
          return "";
        }
        static extractClassId(e) {
          const t = e.className;
          if (!t || "string" != typeof t) return "";
          const r = t.split(" ");
          for (const e of r) if (e.startsWith("e-id-")) return e.substring(5);
          return "";
        }
        static removeNonceFromUrl(e) {
          try {
            const t = new URL(e, window.location.origin);
            t.searchParams.delete("_wpnonce");
            const r = t.searchParams.get("post");
            return (
              null !== r && /^[0-9]+$/.test(r) && t.searchParams.delete("post"),
      ...
      t.default = ActionControlTracking;
    },
    4644: (e, t, r) => {
      "use strict";
      var n = r(5578),
    ...
    5454: (e, t, r) => {
      ...
      var i = n(r(1434));
      const s = "page_views_website_templates",
        o = "kits_cloud_upgrade_clicked",
      ...
      t.appsEventTrackingDispatch = (e, t) => {
        const objectCreator = (e, r) => {
          ...
          s = {};
        (() => {
          objectCreator(n, s), objectCreator(r, i);
          const t = e.split("/");
          (i.placement = t[0]),
            (i.event = t[1]),
            Object.keys(s).length && (i.details = s);
        })(),
          $e.run(e, i);
      };
      t.AppsEventTracking = class AppsEventTracking {
        ...
        static sendKitImportStatus(e = null) {
          const t = !!e;
          return this.dispatchEvent(l, {
            kit_import_status: !t,
            ...(t && { kit_import_error: e.message }),
          });
        }
        ...
        static sendKitCloudLibraryDelete() {
          return this.dispatchEvent(d, { trigger: i.default.triggers.click });
        }
        ...
        static sendKitImportUploadFile(e) {
          return this.dispatchEvent(h, { kit_import_upload_file_status: e });
        }
      };
    },
    5568: (e, t, r) => {
    ...
    6336: (e, t, r) => {
      ...
      var i = (function _interopRequireWildcard(e, t) {
        ...
        s = n(r(6349));
      const o = "li#toplevel_page_elementor",
        a = "li#menu-posts-elementor_library",
        c = "li#toplevel_page_elementor-home",
        l = ".wp-submenu",
        u = ".wp-has-submenu",
        d = "#editor-one-sidebar-navigation";
      class NavigationTracking extends s.default {
        static init() {
          i.default.isEditorOneActive()
        ...
        static attachTemplatesMenuTracking() {
          ...
          e && this.attachMenuTracking(e, "Templates");
        }
        static attachElementorHomeMenuTracking() {
          const e = document.querySelector(c);
          e && this.attachMenuTracking(e, "Elementor");
        }
        ...
        static attachSidebarNavigationTracking() {
          ...
          e && this.attachSidebarClickListener(e);
        }
        static attachSidebarClickListener(e) {
          this.addEventListenerTracked(
            e,
            "click",
            (e) => {
        ...
        static attachMenuTracking(e, t) {
          this.addEventListenerTracked(e, "click", (e) => {
            this.handleMenuClick(e, t);
          });
        }
        static handleMenuClick(e, t) {
          const r = e.target.closest("a");
          if (!r) return;
          const n = r.classList.contains("menu-top"),
            s = this.extractItemId(r),
            o = this.determineNavArea(r);
          i.default.trackNavClicked(s, n ? null : t, o);
        }
        static handleSidebarClick(e) {
          const t = e.target.closest('a, button, [role="button"]');
          if (!t) return;
          const r = this.extractSidebarItemId(t);
          i.default.trackNavClicked(r, null, i.NAV_AREAS.SIDEBAR_MENU);
        }
        static extractSidebarItemId(e) {
          const t = e.querySelector("p");
          if (t) return t.textContent.trim();
          const r = e.textContent.trim();
          return r || "unknown";
        }
        static extractPageFromUrl(e) {
          const t = new URLSearchParams(e.split("?")[1] || ""),
            r = t.get("page");
          if (r) return r;
          const n = t.get("post_type");
          return n || "unknown";
        }
        static extractItemId(e) {
          ...
          if (t) return t;
          const r = e.getAttribute("href");
          if (r) return this.extractPageFromUrl(r);
          const n = e.getAttribute("id");
          return n || "unknown";
        }
        static determineNavArea(e) {
          if (e.closest("li.menu-top")) {
            if (e.closest(l)) {
              return e.closest(u).classList.contains("wp-not-current-submenu")
                ? i.NAV_AREAS.HOVER_MENU
                : i.NAV_AREAS.SUBMENU;
            }
            return i.NAV_AREAS.LEFT_MENU;
          }
          return i.NAV_AREAS.LEFT_MENU;
        }
      }
      t.default = NavigationTracking;
    },
    6349: (e, t, r) => {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        r(4846),
        r(9655);
      t.default = class BaseTracking {
        static ensureOwnArrays() {
          Object.prototype.hasOwnProperty.call(this, "observers") ||
            (this.observers = []),
            Object.prototype.hasOwnProperty.call(this, "eventListeners") ||
              (this.eventListeners = []);
        }
        static destroy() {
          this.ensureOwnArrays(),
            ...
            this.eventListeners.forEach(
              ({ target: e, type: t, handler: r, options: n }) => {
                e.removeEventListener(t, r, n);
              }
            ),
            (this.eventListeners = []);
        }
        static addObserver(e, t, r) {
          this.ensureOwnArrays();
          const n = new MutationObserver(r);
          return n.observe(e, t), this.observers.push(n), n;
        }
        static addEventListenerTracked(e, t, r, n = {}) {
          this.ensureOwnArrays(),
    ...
    7011: (e, t, r) => {
      ...
      const o = "core",
        a = "pro";
      class PluginActions extends s.default {
        ...
        static attachCoreDeactivationTracking() {
          const e = document.querySelector(
            "#elementor-deactivate-feedback-dialog-form"
          );
          e &&
            (this.addEventListenerTracked(e, "change", (e) => {
              const t = e.target;
              t.classList.contains(
                "elementor-deactivate-feedback-dialog-input"
              ) && (this.selectedReason = t.value);
            }),
            this.observeModalButtons());
        }
        static attachProDeactivationTracking() {
          const e = document.querySelector(".plugins");
          e &&
            this.addEventListenerTracked(
              e,
              "click",
        ...
        static observeModalButtons() {
          const checkAndAttachDelegation = () => {
            ...
            return (
              ...
              (this.addEventListenerTracked(
                ...
                "click",
                (e) => {
                  const t = e.target.closest(".dialog-submit"),
                    r = e.target.closest(".dialog-skip");
                  t
                    ? this.trackCoreDeactivation("submit&deactivate")
                    : r && this.trackCoreDeactivation("skip&deactivate");
                },
                { capture: !0 }
              ),
              !0)
          ...
          checkAndAttachDelegation() ||
            this.addObserver(
              document.body,
              { childList: !0, subtree: !0 },
              (e, t) => {
                checkAndAttachDelegation() && t.disconnect();
              }
            );
        }
        static getUserInput() {
          if (
            !this.selectedReason ||
            !["found_a_better_plugin", "other"].includes(this.selectedReason)
          )
            return null;
          const e = document.querySelector(
            `input[name="reason_${this.selectedReason}"]`
          );
          return e && e.value ? e.value : null;
        }
        static trackCoreDeactivation(e) {
          const t = { deactivate_form_submit: e, deactivate_plugin_type: o };
          this.selectedReason &&
            (t.deactivate_feedback_reason = this.selectedReason);
          const r = this.getUserInput();
          r && (t.deactivate_feedback_reason += `/${r}`),
            i.default.dispatchEvent("wpdash_deactivate_plugin", t, {
              send_immediately: !0,
            });
        }
        ...
        static attachProDeletionTracking() {
          "undefined" != typeof jQuery &&
            jQuery(document).on("wp-plugin-deleting", (e, t) => {
              "elementor-pro" === t?.slug && this.trackProAction("delete");
            });
        }
        static destroy() {
          "undefined" != typeof jQuery &&
            jQuery(document).off("wp-plugin-deleting"),
            s.default.destroy.call(this);
        }
        static trackProAction(e) {
          const t = {
            deactivate: {
          ...
          if (!t) return;
          const r = { [t.propertyKey]: a };
          i.default.dispatchEvent(t.eventName, r, { send_immediately: !0 });
        }
      }
      t.default = PluginActions;
    },
    7224: (e, t, r) => {
      "use strict";
      r(5724),
    ...
    7670: (e, t, r) => {
      ...
      var i = (function _interopRequireWildcard(e, t) {
        ...
        s = r(3025),
        o = n(r(6349));
      const a = ".nav-tab-wrapper",
        c = ".nav-tab",
        l = ".nav-tab-active",
        u = ".elementor-settings-form-page",
        d = ".elementor-settings-form-page.elementor-active",
        p = [
          "#elementor-new-floating-elements-modal",
          "#elementor-new-template-dialog-content",
        ];
      class ScreenViewTracking extends o.default {
        static trackedScreens = new Set();
        static init() {
          s.DashboardUtils.isElementorPage() && this.attachTabChangeTracking();
        }
        static destroy() {
          super.destroy(), this.trackedScreens.clear();
        }
        static getScreenData() {
          ...
          let s = "",
            o = "";
          if (
            ((s = t || r || this.getScreenIdFromBody()),
            this.isElementorAppPage())
          ) {
            const e = this.getAppScreenData(n);
            if (e) return e;
          }
          const c = document.querySelector(a),
            p = document.querySelectorAll(u).length > 1;
          if (c || p || (n && !this.isElementorAppPage()))
            if (((o = i.SCREEN_TYPES.TAB), n)) {
              s = `${s}-${n.replace(/^#(tab-)?/, "")}`;
            } else if (c) {
              ...
              if (e) {
                ...
                if (t) s = `${s}-${this.sanitizeScreenId(t)}`;
                else if (r && r.includes("#")) {
                  s = `${s}-${r.split("#")[1]}`;
                }
              }
            } else if (p) {
          ...
          return { screenId: s, screenType: o };
        }
        ...
        static getAppScreenData(e) {
          ...
          return {
            screenId: r.join("/"),
            screenType: i.SCREEN_TYPES.APP_SCREEN,
          };
        }
        static getScreenIdFromBody() {
          const e = document.body.className.split(" ");
          for (const t of e)
            if (
              t.startsWith("elementor") &&
              (t.includes("page") || t.includes("post-type"))
            )
              return t;
          return "elementor-unknown";
        }
        static sanitizeScreenId(e) {
          return e
            .toLowerCase()
            .replace(/[^a-z0-9]+/g, "-")
            .replace(/^-|-$/g, "");
        ...
        static attachNavTabTracking() {
          ...
          e &&
            this.addEventListenerTracked(e, "click", (e) => {
              ...
              if (t && !t.classList.contains("nav-tab-active")) {
                const e = this.getScreenData();
                e && this.trackScreen(e.screenId, e.screenType);
              }
            });
        }
              ...
              for (const t of e)
                "childList" === t.type &&
                  p.forEach((e) => {
                    ...
                    if (t && this.isModalVisible(t)) {
                      const t = e.replace("#", "");
                      this.trackScreen(t, i.SCREEN_TYPES.POPUP);
                    }
                  });
            }
          );
        }
        static isModalVisible(e) {
          if (!e) return !1;
          const t = window.getComputedStyle(e);
          return "none" !== t.display && 0 !== parseFloat(t.opacity);
        }
        static trackScreen(e, t = i.SCREEN_TYPES.TOP_LEVEL_PAGE) {
          const r = `${e}-${t}`;
          this.trackedScreens.has(r) ||
            (this.trackedScreens.add(r), i.default.trackScreenViewed(e, t));
        }
      }
      t.default = ScreenViewTracking;
    },
    7738: (e) => {
      "use strict";
      e.exports = function (e, t) {
    ...
    8285: (e, t, r) => {
      ...
      var i = n(r(3827)),
        s = n(r(6349));
      const o = { go_elementor_pro: "Upgrade" };
      class MenuPromotionTracking extends s.default {
        static init() {
          this.attachDelegatedTracking();
        }
        static attachDelegatedTracking() {
          this.addEventListenerTracked(
            ...
            (e) => {
              ...
              if (!n) return;
              const i = this.extractPromoMenuKey(n);
              i && this.handleMenuPromoClick(r, i);
            },
            { capture: !0 }
          );
        }
        static extractPromoMenuKey(e) {
          for (const t of Object.keys(o)) if (e.includes(`page=${t}`)) return t;
          return null;
        }
        static handleMenuPromoClick(e, t) {
          const r = e.getAttribute("href"),
            n = o[t],
            s = t.replace("elementor_", "").replace(/_/g, "/");
          i.default.trackPromoClicked(n, r, s);
        }
      }
      t.default = MenuPromotionTracking;
    },
    8324: (e, t, r) => {
      "use strict";
      var n = r(3005),
          ...
          return (r, n) => {
            ...
            if (r.hasOwnProperty("uploadedData")) {
              ...
              const t = r.uploadedData.manifest.templates,
                n =
                  elementorAppConfig?.["import-export-customization"]
                    ?.exportGroups || {};
              for (const r in t) {
                if (n[t[r].doc_type] === e) {
                  i = !0;
    ...
    9603: (e, t, r) => {
      ...
      class CarouselHandlerBase extends i.default {
        ...
        a11ySetSlideAriaHidden(e = "") {
          if (
            "number" !=
            typeof ("initialisation" === e ? 0 : this.swiper?.activeIndex)
          )
            return;
          ...
          this.elements.$swiperContainer
            ...
            .each((e, n) => {
              0 <= n.offsetLeft + t && r > n.offsetLeft + t
